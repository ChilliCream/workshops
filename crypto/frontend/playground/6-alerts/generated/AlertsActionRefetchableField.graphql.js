...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "AlertsActionRefetchableField",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "3b3685ee3393a5ac436f9edeca036a77",
    "id": null,
    "metadata": {},
    "name": "AlertsActionRefetchableField",
    "operationKind": "query",
    "text": "query AlertsActionRefetchableField(\n  $count: Int = 5\n  $cursor: String\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...AlertsActionsDAFragment_asset_1G22uz\n    id\n  }\n}\n\nfragment AlertsActionsDAFragment_asset_1G22uz on Asset {\n  symbol\n  alerts(after: $cursor, first: $count) {\n    edges {\n      node {\n        id\n        currency\n        targetPrice\n        percentageChange\n        recurring\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n  id\n}\n"
  }
};
})();
